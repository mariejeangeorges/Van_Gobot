...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        #self.config = tomllib.load("config.toml")
        # configure window
        self.title("CustomTkinter complex_example.py")
        self.geometry(f"{1080}x{525}")
        ...
        self.logo_label = customtkinter.CTkLabel(self.sidebar_frame, text="Paramètres", font=customtkinter.CTkFont(size=20, weight="bold"))
        ...
        self.logo_label = customtkinter.CTkLabel(self.slider_progressbar_frame, text="Grip", font=customtkinter.CTkFont(size=20, weight="bold"))
        ...
        self.slider_2 = customtkinter.CTkSlider(self.slider_progressbar_frame, from_=0, to=700, orientation="horizontal", command=self.sliding, height=10, width=500)
        ...
        self.initial_position_button.grid(row=3, column=1, padx=20, pady=10)
        ...
        self.control_position = customtkinter.CTkFrame(self, fg_color="transparent")
        self.control_position.grid(row=1, column=1, padx=(55, 0), pady=(20, 0), sticky="nsew")
        self.logo_label = customtkinter.CTkLabel(self.control_position, text="Controls", font=customtkinter.CTkFont(size=20, weight="bold"))
        self.logo_label.grid(row=0, column=2, padx=20, pady=(20, 10))

        # Add the buttons for controlling the robot's movement
        self.x_minus_button = customtkinter.CTkButton(self.control_position, text="x-", command=lambda: self.move_robot("x", -1))
        self.x_minus_button.grid(row=1, column=0, padx=(20, 0), pady=(10, 10), sticky="nsew")
        self.x_plus_button = customtkinter.CTkButton(self.control_position, text="x+", command=lambda: self.move_robot("x", 1))
        self.x_plus_button.grid(row=1, column=1, padx=(20, 0), pady=(10, 10), sticky="nsew")

        self.y_minus_button = customtkinter.CTkButton(self.control_position, text="y-", command=lambda: self.move_robot("y", -1))
        self.y_minus_button.grid(row=2, column=0, padx=(20, 0), pady=(10, 10), sticky="nsew")
        self.y_plus_button = customtkinter.CTkButton(self.control_position, text="y+", command=lambda: self.move_robot("y", 1))
        self.y_plus_button.grid(row=2, column=1, padx=(20, 0), pady=(10, 10), sticky="nsew")

        self.z_minus_button = customtkinter.CTkButton(self.control_position, text="z-", command=lambda: self.move_robot("z", -1))
        self.z_minus_button.grid(row=3, column=0, padx=(20, 0), pady=(10, 10), sticky="nsew")
        self.z_plus_button = customtkinter.CTkButton(self.control_position, text="z+", command=lambda: self.move_robot("z", 1))
        self.z_plus_button.grid(row=3, column=1, padx=(20, 0), pady=(10, 10), sticky="nsew")

        self.r_minus_button = customtkinter.CTkButton(self.control_position, text="R-", command=lambda: self.sidebar_button_event)
        self.r_minus_button.grid(row=1, column=3, padx=(20, 0), pady=(10, 10), sticky="nsew")
        self.r_plus_button = customtkinter.CTkButton(self.control_position, text="R+", command=lambda: self.sidebar_button_event)
        self.r_plus_button.grid(row=1, column=4, padx=(20, 0), pady=(10, 10), sticky="nsew")

        self.p_minus_button = customtkinter.CTkButton(self.control_position, text="P-", command=lambda: self.sidebar_button_event)
        self.p_minus_button.grid(row=2, column=3, padx=(20, 0), pady=(10, 10), sticky="nsew")
        self.p_plus_button = customtkinter.CTkButton(self.control_position, text="P+", command=lambda: self.sidebar_button_event)
        self.p_plus_button.grid(row=2, column=4, padx=(20, 0), pady=(10, 10), sticky="nsew")

        self.rpy_minus_button = customtkinter.CTkButton(self.control_position, text="Y-", command=lambda: self.sidebar_button_event)
        self.rpy_minus_button.grid(row=3, column=3, padx=(20, 0), pady=(10, 10), sticky="nsew")
        self.rpy_plus_button = customtkinter.CTkButton(self.control_position, text="Y+", command=lambda: self.sidebar_button_event)
        self.rpy_plus_button.grid(row=3, column=4, padx=(20, 0), pady=(10, 10), sticky="nsew")
    ...
    def update_buttons(self):
        if self.config["enable_photomaton"]:
