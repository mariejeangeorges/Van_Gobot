...
my_slider=customtkinter.CTkSlider(root, from_=0, to=700, command=sliding)
my_slider.pack(pady=40)

my_slider.set(300)
my_label = customtkinter.CTkLabel(root, text="", font=("Helvetica", 15))
...
class App(customtkinter.CTk):
    def __init__(self, width: int = 100,
        ...
        self.sidebar_button_1 = customtkinter.CTkButton(self.control_position, text="X+", command=self.sidebar_button_event)
        self.sidebar_button_1.grid(row=1, column=1, padx=20, pady=10)
        self.sidebar_button_2 = customtkinter.CTkButton(self.control_position, text="X-", command=self.sidebar_button_event)
        self.sidebar_button_2.grid(row=3, column=1, padx=20, pady=10)
        self.sidebar_button_3 = customtkinter.CTkButton(self.control_position, text="Y-", command=self.sidebar_button_event)
        self.sidebar_button_3.grid(row=2, column=0, padx=20, pady=10)
        self.sidebar_button_4 = customtkinter.CTkButton(self.control_position, text="Y+", command=self.sidebar_button_event)
        self.sidebar_button_4.grid(row=2, column=2, padx=20, pady=10)

        """self.logo_label = customtkinter.CTkLabel(self.control_position, text="...",
                                                 font=customtkinter.CTkFont(size=20, weight="bold"))
        self.logo_label.grid(row=0, column=4, padx=20, pady=(20, 10))
        self.sidebar_button_1 = customtkinter.CTkButton(self.control_position, text="Choisir photo",
                                                        command=self.sidebar_button_event)
        self.sidebar_button_1.grid(row=1, column=4, padx=20, pady=10)
        self.sidebar_button_2 = customtkinter.CTkButton(self.control_position, text="Prendre photo",
                                                        command=self.sidebar_button_event)
        self.sidebar_button_2.grid(row=3, column=4, padx=20, pady=10)
        self.sidebar_button_3 = customtkinter.CTkButton(self.control_position, text="Choisir photo",
                                                        command=self.sidebar_button_event)
        self.sidebar_button_3.grid(row=2, column=3, padx=20, pady=10)
        self.sidebar_button_4 = customtkinter.CTkButton(self.control_position, text="Prendre photo",
                                                        command=self.sidebar_button_event)
        self.sidebar_button_4.grid(row=2, column=5, padx=20, pady=10)"""
